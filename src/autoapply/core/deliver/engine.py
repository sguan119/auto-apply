"""autoapply.core.deliver.engine —— FILLING 循环：DOM → LLM → Playwright，逐页（决策四）。
...
from autoapply.core.config import Settings, load_settings
from autoapply.core.contracts import Answer, BioWriteback, FieldValueSource, FilledField, JobRef, Question
from autoapply.core.deliver import browser as browser_primitives
from autoapply.core.deliver.dom import PageSnapshot, collect_page
from autoapply.core.deliver.selector_cache import CacheEntry, SelectorCache, compute_fingerprint
from autoapply.core.llm.client import ElementDecision, LLMClient, LLMDecisionError, PageContext, PageElement
