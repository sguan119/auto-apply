"""autoapply.core.deliver.adapters —— 平台适配层（spec「待续」：适配层最小接口，通用 LLM+DOM 引擎为主）。
...
from autoapply.core.deliver.adapters import workday as _workday  # noqa: F401  触发 WorkdayAdapter 自注册
