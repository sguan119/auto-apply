"""autoapply.core.deliver.adapters.workday —— Workday 门户适配（阶段 7，spec 决策六终态之前的落地平台）。
...
from autoapply.core.deliver.adapters.base import OpenResult, PlatformAdapter, register_adapter
