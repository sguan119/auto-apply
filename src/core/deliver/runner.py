"""core.deliver.runner —— run 编排：单 worker 顺序驱动全部职位的状态机（决策六/七/八，PRD 九）。
...
from core.bio.store import BioStore, YamlBioStore
...
from core.deliver.auth import Authenticator
from core.deliver.browser import BrowserSession
...
from core.deliver.state_machine import IllegalTransition, JobStateMachine
from core.deliver.submit import confirm_and_submit
from core.llm.cli_client import CliLLMClient
